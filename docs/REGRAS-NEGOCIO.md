...
### RN03 — Ato formal de designação do representante

1. A identificação deve conter o ato formal que designa a pessoa responsável por representar o município e gerir as informações do Cadastro Nacional.
2. O sistema deve aceitar, conforme parametrização institucional, portaria, decreto, resolução, ofício ou documento equivalente expedido pela autoridade competente.
3. O arquivo deve ser vinculado ao município, ao responsável autenticado, à data de envio e à versão do processo.
4. No protótipo, são aceitos PDF, ZIP, DOC, DOCX e ODT. A versão de produção deve validar extensão, tamanho, integridade, antivírus e metadados.

### RN04 — Origem da inscrição
...
### RN05 — Comprovação de área de risco
...
4. Ao tentar avançar sem cumprir requisito, o sistema deve manter os dados já preenchidos; na manifestação obrigatória, o botão de avanço deve permanecer desabilitado até o checkbox ser marcado.
